...
argument_parse.add_argument('--gpu', type = str, help = 'needed for training the network')
argument_parse.add_argument('--epochs', action='store', type=int, help='sets epochs to train the model over and over again')
argument_parse.add_argument('--arch', '--a', default='vgg13', help='architecture of choice')
argument_parse.add_argument('--learning_rate', action='store', type= float, help=' learning rate of the model is set')
argument_parse.add_argument('--data_dir', '--d', type=str , help='path to  the folder  that contains flower images')
argument_parse.add_argument('--save_dir', '--s', help='to set the directory to save checkpoints')
arg_cmd = argument_parse.parse_args()
